...
def _setup_parser():
    ...
    # Basic arguments
    parser.add_argument("--data_class", type=str, default="MNISTDataModule")
...
def main():
    ...
    Sample command:
    ```
    python training/run_experiment.py --max_epochs=3 --gpus='0,' --num_workers=20 --model_class=MLP --data_class=MNISTDataModule
    ```
    """
