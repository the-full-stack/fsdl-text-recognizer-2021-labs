...
class ResnetTransformer(nn.Module):
    ...
    def __init__(
        ...
        self.enc_pos_encoder = PositionalEncodingImage(d_model=self.dim, max_h=self.input_dims[1],  max_w=self.input_dims[2])  # Max (Ho, Wo)
    ...
    def predict(self, x: torch.Tensor) -> torch.Tensor:
        ...
        for Sy in range(1, S):
            ...
            #     print(f'LineCNNTransformer.predict(): Early ending of prediction at S={Sy} for batch')
            #     break
